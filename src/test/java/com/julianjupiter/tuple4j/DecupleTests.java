...
public class DecupleTests {
    ...
    void createWithConstructor() {
        var decuple = new Decuple<>(employeeNumber, firstName, lastName, birthday, gender, mobileNumber, emailAddress, address, city, province);
    ...
    void createWithConvenienceFactoryMethod() {
        var decuple = Decuple.of(employeeNumber, firstName, lastName, birthday, gender, mobileNumber, emailAddress, address, city, province);
